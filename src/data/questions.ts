...
// 50 sample German preposition questions
export const questions: Question[] = [
  {
    question: "Ich warte ___ den Bus.",
    options: ["auf", "mit", "zu", "an"],
    answer: "auf",
    explanation: "'warten auf' ist eine feste Präposition im Deutschen für 'to wait for'."
  },
  {
  ...
  {
    question: "Er bedankt sich ___ das Geschenk.",
    options: ["für", "über", "an", "von"],
    answer: "für",
    explanation: "'sich bedanken für' ist die korrekte Präposition bei einem Dank."
  },
  {
  ...
  {
    question: "Wir sprechen ___ das Wetter.",
    options: ["über", "von", "mit", "zu"],
    answer: "über",
    explanation: "'über etwas sprechen' bedeutet, ein Thema zu diskutieren."
  },
  {
  ...
  {
    question: "Er geht ___ seiner Schwester.",
    options: ["zu", "bei", "mit", "von"],
    answer: "zu",
    explanation: "'zu jemandem gehen' bedeutet, jemanden zu besuchen."
  },
  {
    question: "Ich denke oft ___ meinen Urlaub.",
    options: ["an", "über", "von", "für"],
    answer: "an",
    explanation: "'an etwas denken' ist eine feste Verbindung im Deutschen."
  },
  {
    question: "Sie arbeitet ___ Montag ___ Freitag.",
    options: ["von ... bis", "mit ... zu", "aus ... nach", "seit ... auf"],
    answer: "von ... bis",
  ...
  },
  {
    ...
    options: ["an", "auf", "in", "zu"],
    answer: "an",
    explanation: "'an der Wand hängen' beschreibt die Position an einer vertikalen Fläche."
  },
  {
    question: "Die Schule beginnt ___ 8 Uhr.",
    options: ["um", "an", "in", "zu"],
    answer: "um",
    explanation: "'um 8 Uhr' gibt eine präzise Uhrzeit an."
  },
  {
  ...
  {
    question: "Er wartet ___ einer Stunde.",
    options: ["seit", "für", "vor", "um"],
    answer: "seit",
  ...
  {
    question: "Er hat Angst ___ Spinnen.",
    options: ["vor", "über", "gegen", "zu"],
    answer: "vor",
  ...
  {
    question: "Er fährt ___ die Schweiz.",
    options: ["in", "nach", "zu", "auf"],
    answer: "in",
    explanation: "'in die Schweiz fahren' - bei Ländern mit Artikel verwendet man 'in'."
  },
  {
  ...
  {
    question: "Das Restaurant ist ___ der Ecke.",
    options: ["an", "in", "auf", "zu"],
    answer: "an",
    explanation: "'an der Ecke' beschreibt die Position direkt bei einer Straßenecke."
  },
  {
    question: "Wir treffen uns ___ Montag.",
    options: ["am", "im", "zum", "beim"],
    answer: "am",
    explanation: "'am Montag' (an + dem = am) gibt einen bestimmten Tag an."
  },
  {
    question: "Er arbeitet ___ einem Projekt.",
    options: ["an", "mit", "für", "auf"],
    answer: "an",
    explanation: "'an einem Projekt arbeiten' beschreibt die Beschäftigung mit einer Aufgabe."
  },
  {
  ...
  {
    question: "Das Konzert findet ___ Samstag statt.",
    options: ["am", "im", "zum", "beim"],
    answer: "am",
    explanation: "'am Samstag' (an + dem = am) gibt einen bestimmten Tag an."
  },
  {
  ...
  {
    question: "Die Katze sitzt ___ dem Sofa.",
    options: ["auf", "an", "in", "über"],
    answer: "auf",
    explanation: "'auf dem Sofa sitzen' beschreibt die Position oben auf dem Möbelstück."
  },
  {
  ...
  {
    question: "Ich habe ein Geschenk ___ dich.",
    options: ["für", "zu", "an", "mit"],
    answer: "für",
    explanation: "'ein Geschenk für jemanden haben' bedeutet, dass das Geschenk für diese Person bestimmt ist."
  },
  {
  ...
  {
    question: "Das Foto ist ___ meinem Handy.",
    options: ["auf", "in", "an", "bei"],
    answer: "auf",
    explanation: "'auf meinem Handy' - Fotos sind digital auf dem Gerät gespeichert."
  },
  {
  ...
  {
    question: "Wir fahren ___ Italien.",
    options: ["nach", "in", "zu", "auf"],
    answer: "nach",
    explanation: "'nach Italien fahren' - bei Ländern ohne Artikel verwendet man 'nach'."
  }
];
